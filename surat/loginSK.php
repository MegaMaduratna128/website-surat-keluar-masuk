		...
		<div class="col-md-offset-4 col-md-8">
            ...
            <div class="card col-sm-6"  style="background-color:rgb(255, 255, 255);">
                <div class="card-body">
				    ...
				    <form action="cekloginSK.php" class="inner-login" method="post">
						...
						<p> <br>
						    <div class="input-group">
							    ...
							    <input type="text" name="username_usersk" class="form-control" placeholder="Username" autofocus autocomplete="off" required>
						    </div>
					   </div>
					   ...
					   <div class="form-group">
					      <div class="input-group">
							...
							<input type="password" name="password_usersk" class="form-control" placeholder="Password" autocomplete="off" required>
						 </div>
					  </div>
					 ...
					 <div class="form-group">
						...
						$(function(){
							$(".showpass").click(function(){
								if ($("[name=password_usersk]").attr("type")=="password") {
									$("[name=password_usersk]").attr("type","text");
								}else{
									$("[name=password_usersk]").attr("type","password");
								};
							});
						});
						</script>
