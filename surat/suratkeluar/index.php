...
font-size: 16px;"><?php echo "Last access :" . date("d-m-y"); ?>  &nbsp; <a href="../../index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
       ...
       <div id="page-wrapper" >
                ...
                <h3 class="display-4"><center><b> SELAMAT DATANG DI HALAMAN SURAT Keluar </center></h3>
                <hr class="my-2">
                <h5 class="lead"><center><b> User Dapat Menambah, Mengupdate, Menghapus Data Surat Keluar </center></h5>
        </div>
                 <!-- /. ROW  -->           
            </div>
             <!-- /. PAGE INNER  -->
