...
font-size: 16px;"><?php echo "Last access :" . date("d-m-y"); ?>  &nbsp; <a href="../../index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
       ...
       <div id="page-wrapper" >
            ...
            <form action="inputusersk_proses.php" class="inner-login" method="post"> 
                  <tr>
                  <th colspan="2" scope="row"><h2><b>&nbsp;&nbsp;&nbsp;&nbsp; INPUT USER SURAT KELUAR BARU</b></h2></th> 
                  </tr>
                ...
                <td><input type="text" name="username_usersk" id="username_usersk" class="form-control" required></td>
                </tr>
                </div>
                 <br>
                 <div class="form-group">
                ...
                <td><input type="text" name="password_usersk" id="password_usersk" class="form-control" required></td>
                </tr>
                </div>
                 <br>
                ...
                <br>
                <tr>
                <p>  <a class="btn btn-success" href="halamanusersk.php">Kembali</a></a><p> 
                </tr>
