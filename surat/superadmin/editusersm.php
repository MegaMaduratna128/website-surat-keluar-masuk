<?php
  ...
  if (isset($_GET['NIP'])) {
    ...
    // menampilkan data user surat masuk dari database yang mempunyai NIP=$NIP
    $query = "SELECT * FROM user_sm WHERE NIP='$NIP'";
    ...
    $no_hp = $data['no_hp'];
    $alamat = $data['alamat'];
    $username_usersm = $data['username_usersm'];
    $password_usersm = $data['password_usersm'];

  } else {
    echo 'Gagal mengedit data data! ';
    echo '<a href="halamanusersm.php?id='.$NIP.'"> Kembali</a>';
  }
...
font-size: 16px;"><?php echo "Last access :" . date("d-m-y"); ?>  &nbsp; <a href="../../index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
       ...
       <div id="page-wrapper" >
            ...
            <form action="editusersm_proses.php" class="inner-login" id="form_usersm" method="post"> 
            <input type="hidden" name="NIP" value="<?php echo $NIP; ?>" >
                  <tr>
                  <th colspan="2" scope="row"><h2><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Edit User Surat Masuk</b></h2></th> 
                  </tr>
                ...
                <td><input type="text" name="username_usersm" id="username_usersm" class="form-control" value="<?php echo $username_usersm ?>"></td>
                </tr>
                </div>
                 <br>
                <div class="form-group">
                ...
                <td><input type="text" name="password_usersm" id="password_usersm" class="form-control" value="<?php echo $password_usersm ?>"></td>
                </tr>
                </div>
                 <br>
                 ...
                 <tr>
                  ...
                  <input type="submit" name="edit" class="btn btn-success" value="Update Data usersm" />
