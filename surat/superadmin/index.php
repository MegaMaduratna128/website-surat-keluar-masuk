...
font-size: 16px;"><?php echo "Last access :" . date("d-m-y"); ?>  &nbsp; <a href="../../index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
       ...
       <div id="page-wrapper" >
                ...
                <h3 class="display-4"><center><b> SELAMAT DATANG DI HALAMAN SUPER ADMIN </center></h3>
                <hr class="my-2">
                <h5 class="lead"><center><b> Super Admin Dapat Menambah dan Menghapus Data User Surat Masuk </center></h5>
                <h5 class="lead"><center><b> Super Admin Dapat Menambah dan Menghapus Data User Surat Keluar </center></h5>
