...
font-size: 16px;"><?php echo "Last access :" . date("d-m-y"); ?>  &nbsp; <a href="../../index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="justify-content-md-center">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        INFORMASI USER SURAT MASUK
                    </div>
          <div class="panel-body">
                <div class="row">
                    <div class="col-md-9 col-xs-6">
                        <a href="inputusersm.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah User Surat Masuk </a>
                    </div>
                </div>
              <br><br>
    ...
    while($data = mysqli_fetch_assoc($result))
    {
      ...
      echo "<td> &nbsp;&nbsp; $data[username_usersm]</td>"; //menampilkan data username_usersm
      echo "<td> &nbsp;&nbsp; $data[password_usersm]</td>"; //menampilkan data password_usersm
     
      // membuat link untuk mengedit dan menghapus data
      echo '<td> &nbsp;
        
        <a href="hapususersm.php?NIP='.$data['NIP'].'"
