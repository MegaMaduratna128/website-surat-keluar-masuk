    ...
    if(isset($_POST['ubah_foto'])){ // Jika user menceklis checkbox yang ada di form ubah, lakukan :
      ...
      $fotoBaru = $file_disposisi;
        ...
        if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
          // Query untuk menampilkan data suratmasuk berdasarkan no_regrisMasuk yang dikirim
          ...
          // Proses ubah data ke Database
           $query = "UPDATE suratmasuk SET no_suratMasuk='$no_suratMasuk',
           tgl_masuk='$tgl_masuk',alamat_pengirim='$alamat_pengirim',
           tgl_surat='$tgl_surat',perihal='$perihal', isi_disposisi='$isi_disposisi', 
           penerima_surat='$penerima_surat', diteruskan_kepada='$diteruskan_kepada', 
           file_disposisi='$fotoBaru' WHERE no_regrisMasuk='$no_regrisMasuk'";
          $result = mysqli_query($mysqli, $query); // Eksekusi/ Jalankan query dari variabel $query
