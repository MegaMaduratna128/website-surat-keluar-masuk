<?php
  ...
  if (isset($_GET['no_regrisMasuk'])) {
    ...
    echo '<a href="halamansuratmasuk.php?id='.$no_regrisMasuk.'"> Kembali</a>';
...
font-size: 16px;"><?php echo "Last access :" . date("d-m-y"); ?>  &nbsp; <a href="../../index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
       ...
       <div id="page-wrapper" >
            ...
            <form action="editsuratmasuk_proses.php" class="inner-login" id="form_usersm" method="post" enctype="multipart/form-data"> 
            <input type="hidden" name="no_regrisMasuk" value="<?php echo $no_regrisMasuk; ?>" >
                  <tr>
                  <th colspan="2" scope="row"><h2><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Edit Surat Masuk</b></h2></th> 
                  </tr>
                ...
                <td><input type="text" name="no_suratMasuk" id="no_suratMasuk" class="form-control" value="<?php echo $no_suratMasuk ?>"></td>
                </tr>
                </div>
                 <br>
                <div class="form-group">
                ...
                <td><input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control" value="<?php echo $tgl_masuk ?>"></td>
                </tr>
                </div>
                 <br>
                <div class="form-group">
                ...
                <td><input type="text" name="alamat_pengirim" id="alamat_pengirim" class="form-control" value="<?php echo $alamat_pengirim ?>"></td>
                </tr>
                </div>
                <br>
                <div class="form-group">
                ...
                <td><input type="date" name="tgl_surat" id="tgl_surat" class="form-control" value="<?php echo $tgl_surat ?>"></td>
                </tr>
                </div>
                 <br>
                <div class="form-group">
                ...
                <td><?php echo "<img src='surat/$data[file_surat]' width='150'/>"?></td><br>
                  <td> 
                    <input type="checkbox" name="ubah_foto" value="true"> Ceklis jika ingin mengubah foto<br>
                    <input type="file" name="file_surat" id="file_surat">
                   </td>
                   <!-- <td> <input type="file" name="file_surat" class="custom-file-input" id="file_surat" required value="<?php echo $file_surat ?>">
               ...
               <tr>
                ...
                <td><?php echo "<img src='disposisi/$data[file_disposisi]' width='150'/>"?></td><br>
                  <td> 
                    <input type="checkbox" name="ubah_foto1" value="true"> Ceklis jika ingin mengubah foto<br>
                    <input type="file" name="file_disposisi" id="file_disposisi">
                   </td>
                   <!-- <td> <input type="file" name="file_disposisi" class="custom-file-input" id="file_disposisi" required value="<?php echo $file_disposisi ?>">
                    <label class="custom-file-label" for="validatedCustomFile"></label>
                   </td> -->
                 </tr>
                </div>
                 ...
                 <tr>
                  ...
                  <input type="submit" name="edit" class="btn btn-success" value="Simpan Data" />
